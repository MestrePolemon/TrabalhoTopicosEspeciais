...
class FormularioCriarTarefa(FlaskForm):
    ...
    usuarios = SelectMultipleField('Usuarios', option_widget=widgets.CheckboxInput(),
...
class FormularioEditarTarefa(FlaskForm):
    ...
    status = SelectField('Status',
                         choices=[('Pendente', 'Pendente'), ('Em andamento', 'Em andamento'),
                                  ('Concluida', 'Concluida')], validators=[DataRequired()])
    usuarios = SelectMultipleField('Usuarios', option_widget=widgets.CheckboxInput(),
                                   widget=widgets.ListWidget(prefix_label=False))
